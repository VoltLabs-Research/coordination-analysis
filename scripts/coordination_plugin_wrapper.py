...
BINARY_NAME = "coordination-analysis"
PLUGIN_REPO_DIRNAME = "CoordinationAnalysis"
ENV_BINARY_OVERRIDE = "VOLT_COORDINATION_BINARY"
REQUIRED_OUTPUTS = ["_coordination.msgpack", "_atoms.msgpack"]
LOG_TAG = "coordination-plugin"
